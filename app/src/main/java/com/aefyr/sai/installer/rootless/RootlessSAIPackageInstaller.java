...
public class RootlessSAIPackageInstaller extends SAIPackageInstaller {
    ...
    protected void installApkFiles(ApkSource aApkSource) {
        ...
        try (ApkSource apkSource = aApkSource) {
            ...
            PendingIntent pendingIntent = PendingIntent.getService(getContext(), 0, callbackIntent, 0);// not sure if PendingIntent.FLAG_IMMUTABLE is needed here but Android SDK update assistant suggested
